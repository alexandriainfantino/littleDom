 ...
 * @version $Id: test3.java,v 1.1 2014/03/04 23:16:22 asi8443 Exp $
 */
public class test3 {
    ...
    public static void main( String[] args ) {
        ...
        DocObject lst = new ListObject(true);
        lst.addChild(0, new TextObject("this"));
        lst.addChild(1, new TextObject("is"));
        lst.addChild(2, new TextObject("list"));
        sentence.addChild(0, lst);
